...
<div class="max-w-6xl mx-auto mb-4 py-6 px-10 bg-white rounded-xl shadow-md">
    ...
    <form method="POST" class="flex flex-wrap gap-10 mx-3">
        <div class="mb-6">
            ...
            <button type="submit" name="afficher" class="self-center px-4 py-2 bg-blue-500 text-white hover:bg-yellow-400 font-medium rounded-lg transition-colors shadow-md flex items-center">
